<x-admin-base>
    <div class="w-full">
        @if (session('success'))
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mt-[100px]"
                role="alert">
        ...
        @if ($errors->any())
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-[100px]"
                role="alert">
        ...
        <form id="new_game" class="max-w-lg mx-auto mt-[100px] border border-gray-200 p-16" method="POST"
            action="{{ url('/dashboard/new_game') }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                <div class="w-full flex justify-between items-center">
                    <label class="inline-flex items-center mb-5 cursor-pointer" for="active">
                        ...
                        <input type="checkbox" value="1" class="sr-only peer" id="active" name="active"
                            {{ old('active', 1) ? 'checked' : '' }}>
                        <div
                            class="relative ml-2 w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600">
                        </div>
                    </label>
                    <label class="inline-flex items-center mb-5 cursor-pointer" for="free_or_paid">
                        <span class="ms-3 text-sm font-medium text-gray-900">Gratis</span>
                        <input type="checkbox" value="1" class="sr-only peer" id="free_or_paid" name="free_or_paid"
                            {{ old('free_or_paid', 1) ? 'checked' : '' }}>
                        <div
                            class="relative ml-2 w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600">
                        </div>
                    </label>
                    <label class="inline-flex items-center mb-5 cursor-pointer" for="show_in_web">
                        ...
                        <input type="checkbox" value="1" class="sr-only peer" id="show_in_web" name="show_in_web"
                            {{ old('show_in_web', 1) ? 'checked' : '' }}>
                        <div
                            class="relative ml-2 w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600">
                        </div>
                    </label>
